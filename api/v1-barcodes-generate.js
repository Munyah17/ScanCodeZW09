 ...
 * The API is a doorway â€” barcode data is stored in the main platform's
 * `variations` table under the developer's account.
 *
 * Body:
 *   product_id?      â€” bigint; if omitted, a default "API" product is used
 *   country?         â€” ZW|ZA|US|... (default ZW)
 *   variation_type?  â€” e.g. "size", "colour" (default "API")
 *   variation_value? â€” e.g. "500ml", "Red"  (default "generated")
 *   include_qr?      â€” boolean, generate QR alongside (default false)
 *
...
// â”€â”€ EAN-13 engine (mirrors barcodeUtils.js â€” server-side port) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const PREFIXES = {
...
export default async (req) => {
  ...
  // â”€â”€ Sandbox response â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (isSandbox) {
    ...
    return j({
      ...
      barcode: {
        ...
        note:            'SANDBOX â€” test barcode, not saved, not billed.',
      },
      billing: { cost: 0, balance: null, note: 'Sandbox â€” no charges.' },
    });
  }

  // â”€â”€ Live: generate real barcode â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
