...
export default async (req) => {
  ...
  const valErr = firstError([
    { check: hasNewProduct ? isValidLength(product_name, 1, 200) : true,  msg: 'Product name must be 1–200 characters.'  },
    { check: isValidLength(variation_type,  1, 100),                      msg: 'Variation type must be 1–100 characters.' },
    { check: isValidLength(variation_value, 1, 200),                      msg: 'Variation value must be 1–200 characters.'},
