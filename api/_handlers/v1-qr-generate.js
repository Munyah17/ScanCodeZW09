 ...
 *
 * Body:
 *   data             â€” string to encode (URL, text, product code, etc.)
 *   error_correction? â€” L | M | Q | H (default M)
 *   size?            â€” pixel size of output image (default 256, max 1024)
 *
  ...
  if (isSandbox) {
    ...
    return j({
      ...
      qr: {
        ...
        error_correction: ec,
        size:            px,
        note:            'SANDBOX â€” test QR code, not billed.',
      },
