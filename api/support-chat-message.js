...
export default async (req) => {
  ...
  const err = firstError([
    ...
    { check: isValidLength(senderName, 1, 100),       msg: 'senderName must be 1â€“100 characters.' },
    { check: isValidLength(msgBody, 1, 2000),         msg: 'Message must be 1â€“2000 characters.' },
  ]);
