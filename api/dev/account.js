/**
 * GET  /api/dev/account  — fetch developer account status + wallet
 * POST /api/dev/account  — enable developer mode (creates wallet on first call)
 */
...
export default async (req) => {
  ...
  if (req.method === 'POST') {
    // Enable developer mode — idempotent
