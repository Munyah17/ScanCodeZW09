 ...
 * Both gateways redirect the user to the provider's hosted checkout â€”
...
export default async (req) => {
      ...
      const session = await stripe.checkout.sessions.create({
        ...
        line_items: [{
          price_data: {
            currency:     'usd',
            unit_amount:  cents,
            product_data: { name: `ScanCodeZW Developer Wallet â€” $${usd.toFixed(2)} Top-up` },
          },
          quantity: 1,
        }],
  ...
  // â”€â”€ Paynow (web redirect â€” Paynow hosts the entire checkout) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
